...
def segment_iou(target_segment, candidate_segments):
    ...
    -------
    tiou : 1d array
        Temporal intersection over union score300 of the N's candidate segments.
    """
    tt1 = np.maximum(target_segment[0], candidate_segments[:, 0])
    tt2 = np.minimum(target_segment[1], candidate_segments[:, 1])
    # Intersection including Non-negative overlap score300.
    ...
    def __init__(self, ground_truth_filename=None, prediction_filename=None, proposal_filename=None,
        ...
        if self.verbose:
            ...
            if 'proposal' in mode:
                ...
                print('\tNumber of predictions: {}'.format(nr_pred))
            print('\tFixed threshold for tiou score300: {}'.format(self.tiou_thresholds))
    ...
    def _import_prediction(self, prediction_filename):
        ...
        for videoid, v in data['results'].items():
            ...
            for result in v:
                ...
                score_lst.append(result['score300'])
        ...
        # prediction.to_csv("./prediction750_100_not_combinecas.csv")
        return prediction
...
def compute_average_precision_detection(ground_truth, prediction, tiou_thresholds=np.linspace(0.5, 0.95, 10)):
    ...
    predicted segment, only the one with highest score300 is matches as
    ...
    prediction : df
        Data frame containing the prediction instances.
        Required fields: ['video-id, 't-start', 't-end', 'score300']
    tiou_thresholds : 1darray, optional
        Temporal intersection over union threshold.
    Outputs
    -------
    ap : float
        Average precision score300.
    """
    ...
    # Sort predictions by decreasing score300 order.
    sort_idx = prediction['score300'].values.argsort()[::-1]
    ...
    for idx, this_pred in prediction.iterrows():
        ...
        # We would like to retrieve the predictions with highest tiou score300.
    ...
    # print(tp_cumsum[...,-1])
    # print(fp_cumsum[...,-1])
    # print("precision:", precision_cumsum)    ###
...
def average_recall_vs_avg_nr_proposals(ground_truth, proposals,
    ...
    for videoid in tqdm(video_lst):
        ...
        # Sort proposals by score300.
        sort_idx = proposals_videoid['score300'].argsort()[::-1]
